          ...
          <form onSubmit={submit}>
            <div>
              ...
              <input
                type="text"
                id="productName"
                name="updatedProductName[productName]"
            ...
            <div>
              ...
              <input
                type="number"
                id="timeToMake"
                name="updatedProductTimeToMake[timeToMake]"
                value={updatedProduct.timeToMake}
                onChange={(evt) =>
                  setUpdatedProduct({
                    ...updatedProduct,
                    timeToMake: evt.target.value,
                  })
                }
              />
            </div>
            <div>
              <label htmlFor="totalMaterialsCost">
              ...
              <input
                ...
                defaultValue={updatedProduct.totalMaterialsCost}
                onChange={(evt) =>
                  setUpdatedProduct({
                    ...updatedProduct,
                    totalMaterialsCost: parseFloat(evt.target.value).toFixed(2),
                  })
                }
              />
            </div>
